...
SECRET_KEY = 'tmt80g=8cmw1%#l7smy)nkg2v0v2)w59sz#ivh1c)@)h^lv6+$'
...
TEMPLATES = [
    {
        ...
        'DIRS': [r'C:\Users\abhinandan kapoor\PycharmProjects\jobs\jobs_app\templates'],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
